...
by taking advantage of the data, thread, and instruction parallelism offered by modern multi-core hardware. In this paper, we provide multi-core architecture-based methods to \ parallelize different image processing algorithms. First, this paper will briefly describe some image processing algorithms and details of the systems used for performing  \
image processing. Later, it will elaborate on the single-core CPU, multi-core CPU, and the GPU-based approaches for image processing. Finally, this report will provide a \ detailed experimental analysis of the performance of different image processing algorithms by using \
